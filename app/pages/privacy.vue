<template>
  <div class="container mx-auto max-w-2xl py-12 px-4">
    ...
    <p class="mb-6 text-gray-600 dark:text-gray-300">
      We value your privacy. This page explains how we collect, use, and protect your information
      when you use Urlsclickearn.
    </p>
    ...
    <p class="text-gray-500 text-sm">
      ...
      <a href="mailto:admin.rs@urlsclickearn.xyz" class="text-blue-600"
        >admin.rs@urlsclickearn.xyz</a
      >.
    </p>
  </div>
</template>
