    ...
    <div class="w-full max-w-md">
      <div class="bg-white rounded-xl shadow-2xl overflow-hidden">
        <div class="bg-gradient-to-r from-[#FF6B35] to-[#F72B7E] p-6 text-center">
          <div
            class="inline-flex items-center justify-center w-20 h-20 bg-white/20 backdrop-blur rounded-full mb-4"
          >
        ...
        <form class="p-8 space-y-6" @submit.prevent="submit">
          ...
          <div>
            ...
            <div class="mt-3 space-y-2">
              <div class="flex items-center space-x-2">
                ...
                <span
                  class="text-sm"
                  :class="[password.length >= 8 ? 'text-green-600 font-medium' : 'text-gray-500']"
                >
              ...
              <div class="flex items-center space-x-2">
                <div
                  class="w-3 h-3 rounded-full transition-colors"
                  :class="[/[0-9]/.test(password) ? 'bg-green-500' : 'bg-gray-300']"
                />
                <span
                  class="text-sm"
                  :class="[/[0-9]/.test(password) ? 'text-green-600 font-medium' : 'text-gray-500']"
                >
                  One number
                </span>
              </div>
              <div class="flex items-center space-x-2">
                ...
                <span
                  class="text-sm"
                  :class="[hasSpecialChar ? 'text-green-600 font-medium' : 'text-gray-500']"
                >
          ...
          <div class="flex items-start">
            ...
            <label for="terms" class="ml-2 text-sm text-gray-600">
              I agree to the
              <a href="#" class="text-[#FF6B35] hover:text-[#F72B7E] font-medium"
                >Terms of Service</a
              >
              and
