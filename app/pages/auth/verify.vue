  ...
  <div class="min-h-screen bg-gradient-to-br from-orange-50 to-pink-50 flex items-center justify-center p-4">
    <div class="max-w-md w-full space-y-8">
      <div class="text-center">
        <div class="mx-auto w-16 h-16 bg-gradient-to-br from-[#FF6B35] to-[#F72B7E] rounded-full flex items-center justify-center">
      ...
      <div class="bg-white p-8 rounded-lg shadow-md">
        ...
        <div class="mt-4 text-center">
          <NuxtLink to="/auth/login" class="text-sm text-[#FF6B35] hover:text-[#F72B7E] transition-colors duration-300">
            Back to Sign In
          </NuxtLink>
        </div>
      </div>
