  ...
  <div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-50 to-pink-50">
    <div class="p-8 bg-white rounded-xl shadow-2xl w-full max-w-md">
      ...
      <form class="space-y-6" @submit.prevent="submit">
        ...
        <div v-if="msg" class="p-4 rounded-lg text-sm font-medium mt-2" :class="[
        ...
        <div class="flex items-center justify-between">
          <label class="flex items-center">
            <input type="checkbox" class="rounded border-gray-300 text-[#FF6B35] focus:ring-[#FF6B35]" />
            <span class="ml-2 text-sm text-gray-600">Remember me</span>
          </label>
          <a href="/auth/reset-password"
            class="text-sm font-medium text-[#FF6B35] hover:text-[#F72B7E] transition-colors">Forgot password?</a>
        </div>
      ...
      <p class="text-center text-sm text-gray-600 mt-8">
        ...
        <a href="/auth/signup" class="font-medium text-[#FF6B35] hover:text-[#F72B7E] transition-colors">Sign up now</a>
      </p>
    </div>
  </div>
</template>
