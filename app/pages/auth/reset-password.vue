...
<template>
  <div
    class="flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-50 to-pink-50"
  >
    <div class="p-8 bg-white rounded-xl shadow-2xl w-full max-w-md">
      <div class="text-center mb-6">
        <div
          class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#FF6B35] to-[#F72B7E] rounded-full mb-4"
        >
        ...
        <h1
          class="text-3xl font-bold bg-gradient-to-r from-[#FF6B35] to-[#F72B7E] bg-clip-text text-transparent"
        >
          Reset Password
        </h1>
        ...
        <p v-else class="text-gray-600 mt-2">Choose a new password</p>
      </div>
      ...
      <form v-if="step === 'email'" class="space-y-6" @submit.prevent="requestReset">
        <div>
          ...
          <p class="mt-2 text-sm text-gray-500">We'll send you a code to reset your password</p>
        </div>
      ...
      <form v-else-if="step === 'code'" class="space-y-6" @submit.prevent="verifyCode">
        <div>
          ...
          <p class="mt-2 text-sm text-gray-500">Enter the 6-digit code sent to {{ email }}</p>
        </div>
      ...
      <div class="mt-8 text-center">
        <p class="text-sm text-gray-600">
          ...
          <a
            href="/auth/login"
            class="font-medium text-[#FF6B35] hover:text-[#F72B7E] transition-colors"
            >Sign in</a
          >
        </p>
