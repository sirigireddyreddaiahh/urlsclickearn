...
function openQR() {
  ...
  window.open(
    `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(short.value)}`,
    '_blank'
  );
}
            ...
            <form class="space-y-6" @submit.prevent="createShort">
              <div class="grid md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input v-model="slug" type="text" class="form-input" placeholder="my-link" />
                </div>
              </div>
              ...
              <div class="flex flex-wrap gap-4 items-center">
                ...
                <NuxtLink to="/dashboard/links" class="btn-secondary">
            ...
            <transition name="scale-in">
              <div v-if="short" class="result-card">
                ...
                <div class="result-content">
                  <input :value="short" readonly class="result-input" @click="selectAll" />
      ...
      <section class="cta-section">
        <div class="container mx-auto px-4 text-center">
          ...
          <div class="cta-buttons">
            <button class="btn-primary btn-large" @click="scrollToTop">Get Started Free</button>
            <NuxtLink to="/dashboard/links" class="btn-secondary btn-large">
              View Dashboard
            </NuxtLink>
          </div>
        </div>
