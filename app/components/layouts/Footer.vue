...
<template>
  ...
  >
    ...
    <section class="md:pt-8">
      <div
        class="container flex flex-col items-center py-8 mx-auto sm:flex-row max-w-7xl px-4 sm:px-6 lg:px-8"
      >
        ...
        <div class="flex-shrink-0 mb-6 sm:mb-0">
          ...
          >
            ...
            <div class="relative">
              ...
              >
                <img src="/sink.png" :alt="title" class="w-8 h-8 rounded-lg" loading="lazy" />
              </div>
      ...
      <div
        class="border-t border-slate-200/50 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-900/50"
      >
