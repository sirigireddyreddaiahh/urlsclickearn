...
<template>
  <TriggerTemplate>
    ...
    >
      <div
        ...
        :class="selectedLinks.length ? 'text-foreground' : 'text-muted-foreground'"
      >
        {{ selectedLinks.length ? selectedLinks.join(', ') : 'Filter Placeholder' }}
      </div>
  ...
  <FilterTemplate>
    <Command v-model="selectedLinks" multiple>
      <CommandInput
        :placeholder="selectedLinks.length ? selectedLinks.join(', ') : 'Filter Placeholder'"
      />
